  ...
  <body> 
    ...
    <center>
      <table width="610" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td>
            <div style="color:#FF0000; padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:15px; text-align:center;">
              <b>Operação não realizada devido erro no sistema.</b> 
              <%--=exception--%>
            </div>
          </td>
        </tr>
