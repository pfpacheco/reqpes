...
public class InstrucaoControl{
  ...
  public InstrucaoControl(){
   ...
   public int getCotaCargo(String codUnidade, int codCargo, int codTabSalarial, String segmento4) throws RequisicaoPessoalException{
      String condicao = "";
      ...
      switch(codTabSalarial){
        ...
        case 7: //-- TABELA 05 - MONITORES
	    		...
	    		//condicao = (segmento4.trim().equals(""))?"":" AND COD_AREA_SUBAREA = '" + segmento4 + "'";
   ...
   public boolean validaIN15(String codUnidade, int codCargo, int cotaCargo, int codTabSalarial, String segmento4) throws RequisicaoPessoalException{
      String condicao = "";
      ...
      //-- Retorno: 0 (Erro, não encontrado) / 1 (Sucesso, quantidade de registros)
