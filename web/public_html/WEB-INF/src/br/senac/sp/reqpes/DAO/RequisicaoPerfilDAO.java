...
public class RequisicaoPerfilDAO implements InterfaceDataBase{
   ...
   */
   ...
   private int dmlRequisicaoPerfil(int tipoDML, RequisicaoPerfil requisicaoPerfil)throws RequisicaoPessoalException{
    ...
    try{
      ...
      sucesso = 0;
      throw new RequisicaoPessoalException( "Ocorreu um erro ao "+ tipoTransacao +" a RequisicaoPerfil: \n: "+ parametros.toString(), e.getMessage());
    }catch(Exception e){
      sucesso = 0;
      throw new RequisicaoPessoalException("Ocorreu um erro ao "+ tipoTransacao +" a RequisicaoPerfil: \n: "+ parametros.toString(), e.getMessage());
    }finally{
  ...
  */
  ...
  /**
   * Retorna uma instancia da classe RequisicaoPerfil, de acordo com o codigo informado
   * @return RequisicaoPerfil
   * @throws br.senac.sp.exception.RequisicaoPessoalException
   */
  ...
  /**
   * Retorna um array de objetos RequisicaoPerfil que satifaz a condição informada
   * @param condicao
