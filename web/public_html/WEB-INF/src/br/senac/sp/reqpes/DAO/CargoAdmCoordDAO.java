...
public class CargoAdmCoordDAO implements InterfaceDataBase {
  ...
  /**
   * @return int
   * @param  cargoAdmCoord, usuario
   * @Procedure PROCEDURE SP_DML_CARGO_ADM_COORD(P_IN_DML         IN NUMBER
                                                ,P_IN_COD_UNIDADE IN VARCHAR2
                                                ,P_IN_USUARIO     IN NUMBER) IS
   */
   
   private int dmlCargoAdmCoord(int tipoDML, CargoAdmCoord cargoAdmCoord, Usuario usuario) throws RequisicaoPessoalException{
