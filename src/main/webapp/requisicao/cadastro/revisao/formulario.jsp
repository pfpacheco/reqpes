...
<script language="javaScript">
  function submeter(){
    if(decode(document.frm.dscMotivo,"Informe o motivo da solicitação de revisão da Requisição!",0,"",null)){
        document.frm.submit();
    }
  }  
</script>
...
<center>
  <form name="frm" method="POST" action="solicitarRevisao.jsp">
  <input type="HIDDEN" name="codRequisicao" value="<%=codRequisicao%>">
    <table border="0" cellpadding="0" cellspacing="0" width="610" >
	  ...
	  <tr>
		...
		<br>
		 <strong>Motivo da solicitação de revisão da requisição nº <%=codRequisicao%>&nbsp;</strong>(Limite 2000 caracteres)&nbsp;
