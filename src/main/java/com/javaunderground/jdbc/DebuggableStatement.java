...
public class DebuggableStatement implements PreparedStatement {
	 ...
	 * 
	 */
	protected DebuggableStatement(Connection con, String sqlStatement, SqlFormatter formatter, DebugLevel debugLevel)
			throws SQLException {
	...
	private void saveObject(int parameterIndex, Object o) throws ParameterIndexOutOfBoundsException {
		if (parameterIndex > variables.length)
			throw new ParameterIndexOutOfBoundsException(
					"Parameter index of " + parameterIndex + " exceeds actual parameter count of " + variables.length);
	...
	public String toString() {
		...
		if (debugLevel == DebugLevel.ON)
			...
			return new String(unfilterSql) + System.getProperty("line.separator") + System.getProperty("line.separator")
					+ "query executed in " + executeTime + " milliseconds" + System.getProperty("line.separator");
