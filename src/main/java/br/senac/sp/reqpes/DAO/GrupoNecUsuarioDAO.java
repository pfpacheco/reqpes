...
public class GrupoNecUsuarioDAO implements InterfaceDataBase{
   ...
   */
   ...
   private int dmlGrupoNecUsuario(int tipoDML, GrupoNecUsuario grupoNecUsuario, Usuario usuario) throws RequisicaoPessoalException{
  ...
  */
  public int gravaGrupoNecUsuario(GrupoNecUsuario grupoNecUsuario, Usuario usuario) throws RequisicaoPessoalException{
   ...
   * @procedure: SP_DML_GRUPO_NEC_USUARIOS
  */
  public int deletaGrupoNecUsuario(GrupoNecUsuario grupoNecUsuario, Usuario usuario) throws RequisicaoPessoalException{
    return this.dmlGrupoNecUsuario(-1, grupoNecUsuario, usuario);
  }


  /**
   * Retorna uma instancia da classe GrupoNecUsuario, de acordo com o codigo informado
  ...
  /**
   * Retorna um array de objetos GrupoNecUsuario que satifaz a condição informada
   * @param condicao
  ...
  */
  public String[][] getUsuariosByUnidade(String codUnidade) throws RequisicaoPessoalException{
    ...
    sql.append(" AND    GU.COD_GRUPO      = (SELECT GUO.COD_GRUPO ");
    sql.append("                             FROM   GRUPO_NEC_UNIDADES GUO ");
    sql.append("                             WHERE  GUO.COD_UNIDADE = '" + codUnidade + "') ");
