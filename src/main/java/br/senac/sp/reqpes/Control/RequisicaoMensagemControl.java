...
import br.senac.sp.reqpes.util.*;
...
public class RequisicaoMensagemControl{
   ...
   * @param  usuario, requisicao, mensagem, emailPara, assunto
   * @throws RequisicaoPessoalException, AdmTIException
   */
  public static void enviaMensagemCriacao(Usuario usuario, Requisicao requisicao, String mensagem, String emailPara, String assunto) throws RequisicaoPessoalException, AdmTIException{
   ...
   * @param  usuario, requisicao, emailPara
   * @throws RequisicaoPessoalException, AdmTIException
   */
  public static void enviaMensagemCriacao(Usuario usuario, Requisicao requisicao, String emailPara) throws RequisicaoPessoalException, AdmTIException{
   ...
   * @param  usuario, requisicao
   * @throws RequisicaoPessoalException, AdmTIException
   */
  public static void enviaMensagemHomologacaoUO(Usuario usuario, Requisicao requisicao) throws RequisicaoPessoalException, AdmTIException{     
    //-- Objetos
    ...
    // Adicionando os emails dos homologadores da unidade aprovadora na lista de envio (HOMOLOGADORES - GEP)
  ...
  /**
   * Envia mensagem para os homologadores da GEP (NEC) e participantes no Workflow de aprovação
   * @param  usuario, requisicao, emailPara[]
   * @throws RequisicaoPessoalException, AdmTIException
   */
  public static void enviaMensagemHomologacaoAPeB(Usuario usuario, Requisicao requisicao, String[] emailPara) throws RequisicaoPessoalException{
  ...
  /**
   * Envia mensagem para os homologadores da GEP (AP&B) e participantes no Workflow de aprovação
   * @param  usuario, requisicao, emailPara[]
   * @throws RequisicaoPessoalException, AdmTIException
   */
  public static void enviaMensagemHomologacaoNEC(Usuario usuario, Requisicao requisicao, String[] emailPara) throws RequisicaoPessoalException{
  ...
  /**
   * Envia mensagem notificando o gerente da unidade responsável e o gerente da unidade aprovadora (GEP)
   * @param  usuario, requisicao
   * @throws RequisicaoPessoalException, AdmTIException
   */    
  public static void enviaMensagemHomologacaoGEP(Usuario usuario, Requisicao requisicao) throws RequisicaoPessoalException, AdmTIException{
    ...
    SistemaParametro codUnidadeAprovadora = sistemaParametroControl.getSistemaParametroPorSistemaNome(Config.ID_SISTEMA, "UNIDADE_APROVADORA");
  ...
  * @throws RequisicaoPessoalException, AdmTIException
  */  
  public static void enviaMensagem(Requisicao requisicao, String mensagem, String[] emailPara, String assunto) throws RequisicaoPessoalException, AdmTIException{
    ...
    try{
      ...
      emailRemetente = sistemaParametroControl.getSistemaParametroPorSistemaNome(Config.ID_SISTEMA, "EMAIL_REMETENTE");
    }catch (Exception e){
  ...
  * @throws RequisicaoPessoalException, AdmTIException
  */   
  public static void enviaMensagem(Usuario usuario, Requisicao requisicao, String mensagem, String[] emailPara, String assunto) throws RequisicaoPessoalException, AdmTIException{
