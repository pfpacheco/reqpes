...
public class RequisicaoJornadaControl {
	...
	public String[][] getEscala(String jornadaTrabalho, String[] dias, String[] classificacao, String[] entrada,
			String[] intervalo, String[] retorno, String[] saida) throws RequisicaoPessoalException {
	...
	public String[][] getIdCalendario(String codUnidade, String indSegunda, String indTerca, String indQuarta,
			String indQuinta, String indSexta, String indSabado, String indDomingo) throws RequisicaoPessoalException {
		return requisicaoJornadaDAO.getIdCalendario(codUnidade, indSegunda, indTerca, indQuarta, indQuinta, indSexta,
				indSabado, indDomingo);
	}
}