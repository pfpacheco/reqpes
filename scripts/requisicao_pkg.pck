CREATE OR REPLACE PACKAGE REQPES.REQUISICAO_PKG IS
  ...
  PROCEDURE SP_DML_REQUISICAO(P_IN_DML        IN NUMBER,
                              P_IN_REQUISICAO IN OUT REQUISICAO%ROWTYPE,
                              P_IN_USUARIO    IN VARCHAR2,
                              P_UO_DESTINO    IN VARCHAR2,
                              P_NIVEL         IN NUMBER,
                              P_TIPO          IN NUMBER);

  PROCEDURE SP_DML_REQUISICAO_PERFIL(P_IN_DML                   IN NUMBER,
                                     P_IN_REQUISICAO_PERFIL     IN OUT REQUISICAO_PERFIL%ROWTYPE,
                                     P_IN_LIST_FUNCAO           IN VARCHAR2,
                                     P_IN_GRAVA_HISTORICO_CHAPA IN NUMBER,
                                     P_IN_SO_PERFIL             IN NUMBER);

  PROCEDURE SP_DML_REQUISICAO_JORNADA(P_IN_DML                IN NUMBER,
                                      P_IN_REQUISICAO_JORNADA IN OUT REQUISICAO_JORNADA%ROWTYPE,
                                      P_IN_CHAPA              IN NUMBER);

  PROCEDURE SP_DML_USUARIO_AVISO(P_IN_DML           IN NUMBER,
                                 P_IN_USUARIO_AVISO IN OUT USUARIO_AVISO%ROWTYPE,
                                 P_IN_USUARIO       IN VARCHAR2);

  PROCEDURE SP_DML_REQUISICAO_BAIXA(P_IN_DML              IN NUMBER,
                                    P_IN_REQUISICAO_BAIXA IN OUT REQUISICAO_BAIXA%ROWTYPE,
                                    P_IN_USUARIO          IN VARCHAR2);

  PROCEDURE SP_DML_REQUISICAO_ESTORNO(P_IN_DML                IN NUMBER,
                                      P_IN_REQUISICAO_ESTORNO IN OUT HISTORICO_REQUISICAO%ROWTYPE,
                                      P_IN_USUARIO            IN VARCHAR2,
                                      P_IN_IND_TIPO_ESTORNO   IN VARCHAR2);

  PROCEDURE SP_DML_REQUISICAO_REVISAO(P_IN_DML                IN NUMBER,
                                      P_IN_REQUISICAO_REVISAO IN OUT REQUISICAO_REVISAO%ROWTYPE,
                                      P_IN_USUARIO            IN VARCHAR2,
                                      P_IN_PERFIL_HOM         IN NUMBER,
                                      P_IN_CHAPA              IN VARCHAR2);

  PROCEDURE SP_DML_REQUISICAO_HOMOLOGACAO(P_IN_TIPO       IN VARCHAR2,
                                          P_IN_REQUISICAO IN HISTORICO_REQUISICAO%ROWTYPE,
                                          P_IN_USUARIO    IN VARCHAR2,
                                          P_IN_DSC_MOTIVO IN VARCHAR2);

  PROCEDURE SP_DML_SUBSTITUICAO_GERENTE(P_IN_DML          IN VARCHAR2,
                                        P_IN_SUBSTITUICAO IN RESPONSAVEL_ESTRUTURA%ROWTYPE,
                                        P_IN_TEOR_COD     IN VARCHAR2);

  PROCEDURE SP_DML_TABELA_SALARIAL(P_IN_DML             IN NUMBER,
                                   P_IN_TABELA_SALARIAL IN OUT TABELA_SALARIAL%ROWTYPE,
                                   P_IN_USUARIO         IN VARCHAR2);

  PROCEDURE SP_DML_TAB_SALARIAL_ATRIBUICAO(P_IN_DML                     IN NUMBER,
                                           P_IN_TAB_SALARIAL_ATRIBUICAO IN OUT TABELA_SALARIAL_ATRIBUICAO%ROWTYPE);

  PROCEDURE SP_DML_INSTRUCAO(P_IN_DML       IN NUMBER,
                             P_IN_INSTRUCAO IN OUT INSTRUCAO%ROWTYPE,
                             P_IN_USUARIO   IN VARCHAR2);

  PROCEDURE SP_DML_INSTRUCAO_ATRIBUICAO(P_IN_DML                  IN NUMBER,
                                        P_IN_INSTRUCAO_ATRIBUICAO IN OUT INSTRUCAO_ATRIBUICAO%ROWTYPE);

  PROCEDURE SP_DML_GRUPO_NEC(P_IN_DML       IN NUMBER,
                             P_IN_GRUPO_NEC IN OUT GRUPO_NEC%ROWTYPE,
                             P_IN_USUARIO   IN VARCHAR2);

  PROCEDURE SP_DML_GRUPO_NEC_UNIDADES(P_IN_DML                IN NUMBER,
                                      P_IN_GRUPO_NEC_UNIDADES IN OUT GRUPO_NEC_UNIDADES%ROWTYPE);

  PROCEDURE SP_DML_GRUPO_NEC_USUARIOS(P_IN_DML                IN NUMBER,
                                      P_IN_GRUPO_NEC_USUARIOS IN OUT GRUPO_NEC_USUARIOS%ROWTYPE,
                                      P_IN_USUARIO            IN VARCHAR2);

  PROCEDURE SP_DML_CARGO_ADM_COORD(P_IN_DML                IN NUMBER,
                                   P_IN_UO_CARGO_ADM_COORD IN UO_CARGO_ADM_COORD%ROWTYPE,
                                   P_IN_USUARIO            IN VARCHAR2);

  PROCEDURE SP_DML_TIPO_AVISO(P_IN_DML        IN NUMBER,
                              P_IN_TIPO_AVISO IN OUT TIPO_AVISO%ROWTYPE,
                              P_IN_USUARIO    IN VARCHAR2);

  PROCEDURE SP_REQUISICAO_PERFIL_FUNCAO(P_REQUISICAO_SQ IN REQUISICAO.REQUISICAO_SQ%TYPE,
                                        P_LIST_FUNCAO   IN VARCHAR2);
...
CREATE OR REPLACE PACKAGE BODY REQPES.REQUISICAO_PKG IS
  ...
  BEGIN
    RETURN REPLACE(REPLACE(REPLACE(REPLACE(P_TEXT, Chr(34), ''),
                                   Chr(10),
                                   ''),
                           Chr(13),
                           ''),
  ...
  EXCEPTION
    WHEN OTHERS THEN
      ...
      RAISE_APPLICATION_ERROR(-20025,
                              'PROBLEMA AO REMOVER CARACTERES' || SQLERRM);
  ...
  BEGIN
    BEGIN
      ...
      IF (P_IN_DML = 0) THEN
        ...
        -----------------------------------------------------
        IF (P_IN_DML IN (0, 1) AND
           P_IN_REQUISICAO.MOTIVO_SOLICITACAO IN ('2', '3')) THEN
      ...
      ELSIF (P_IN_DML > 0) THEN
        ...
        SELECT USUARIO_SQ, NIVEL, COD_UNIDADE, UNIDADE, IDENTIFICACAO
          INTO V_SQ_USUARIO,
               V_NIVEL_USUARIO,
               V_USUARIO_COD_UNIDADE,
               V_UNIDADE_USUARIO,
               V_IDENTIFICACAO_USUARIO
          FROM USUARIO
         WHERE USUARIO_SQ = P_IN_REQUISICAO.USUARIO_SQ;

        SELECT COD_UNIDADE, NIVEL
          INTO V_COD_UNIDADE_HISTORICO, V_NIVEL_HISTORICO
          FROM (SELECT COD_UNIDADE, NIVEL
        ...
        IF P_IN_REQUISICAO.CARGO_SQ != V_CARGO_SQ THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT CD.DESCRICAO FROM CARGOS C, CARGO_DESCRICOES CD WHERE C.ID= ' ||
                                                   V_CARGO_SQ ||
                                                   ' AND C.ID = CD.ID AND C.IN_SITUACAO_CARGO = "A"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT CD.DESCRICAO FROM CARGOS C, CARGO_DESCRICOES CD   WHERE  C.ID= ' ||
                                                   P_IN_REQUISICAO.CARGO_SQ ||
                                                   ' AND C.ID = CD.ID AND C.IN_SITUACAO_CARGO = "A"');
        ...
        IF P_IN_REQUISICAO.MOTIVO_SOLICITACAO != V_MOTIVO_SOLICITACAO THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT DESCRICAO FROM SOLICITACAO_MOTIVO WHERE ID=' ||
                                                   V_MOTIVO_SOLICITACAO);
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT DESCRICAO FROM SOLICITACAO_MOTIVO WHERE ID=' ||
                                                   P_IN_REQUISICAO.MOTIVO_SOLICITACAO);
          INSERT INTO historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
        ...
        IF P_IN_REQUISICAO.COD_RECRUTAMENTO != V_COD_RECRUTAMENTO THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT DESCRICAO  FROM RECRUTAMENTO WHERE ID_RECRUTAMENTO =' ||
                                                   V_COD_RECRUTAMENTO);
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT DESCRICAO  FROM RECRUTAMENTO WHERE ID_RECRUTAMENTO =' ||
                                                   P_IN_REQUISICAO.COD_RECRUTAMENTO);
          insert into historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
        ...
        IF P_IN_REQUISICAO.CLASSIFICACAO_FUNCIONAL !=
           V_CLASSIFICACAO_FUNCIONAL THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT CLFU_DES FROM CLASSIFICACAO_FUNCIONAL WHERE CLFU_COD=' ||
                                                   V_CLASSIFICACAO_FUNCIONAL);
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT CLFU_DES FROM CLASSIFICACAO_FUNCIONAL WHERE CLFU_COD=' ||
                                                   P_IN_REQUISICAO.CLASSIFICACAO_FUNCIONAL);
          INSERT INTO historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
        ...
        IF P_IN_REQUISICAO.COD_SEGMENTO1 != V_COD_SEGMENTO1 THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   V_COD_SEGMENTO1 ||
                                                   ' AND  T.TIPO_SEGMENTO=1 AND T.COD_SEGMENTO <> "-"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   P_IN_REQUISICAO.COD_SEGMENTO1 ||
                                                   ' AND T.TIPO_SEGMENTO=1 AND T.COD_SEGMENTO <> "-"');
          insert into historico_perfil_campos
            (requisicao_sq,
        ...
        IF P_IN_REQUISICAO.COD_SEGMENTO2 != V_COD_SEGMENTO2 THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   V_COD_SEGMENTO2 ||
                                                   ' AND T.TIPO_SEGMENTO=2 AND T.COD_SEGMENTO <> "-"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   P_IN_REQUISICAO.COD_SEGMENTO2 ||
                                                   ' AND T.TIPO_SEGMENTO=2 AND T.COD_SEGMENTO <> "-"');
          insert into historico_perfil_campos
        ...
        IF P_IN_REQUISICAO.COD_SEGMENTO3 != V_COD_SEGMENTO3 THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   V_COD_SEGMENTO3 ||
                                                   ' AND T.TIPO_SEGMENTO=3 AND T.COD_SEGMENTO <> "-"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   P_IN_REQUISICAO.COD_SEGMENTO3 ||
                                                   ' AND T.TIPO_SEGMENTO=3 AND T.COD_SEGMENTO <> "-"');
          insert into historico_perfil_campos
        ...
        IF P_IN_REQUISICAO.COD_SEGMENTO4 != V_COD_SEGMENTO4 THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   V_COD_SEGMENTO4 ||
                                                   ' AND T.TIPO_SEGMENTO=4 AND T.COD_SEGMENTO <> "-"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   P_IN_REQUISICAO.COD_SEGMENTO4 ||
                                                   ' AND T.TIPO_SEGMENTO=4 AND T.COD_SEGMENTO <> "-"');
          insert into historico_perfil_campos
        ...
        IF P_IN_REQUISICAO.COD_SEGMENTO5 != V_COD_SEGMENTO5 THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   V_COD_SEGMENTO5 ||
                                                   ' AND T.TIPO_SEGMENTO=5 AND T.COD_SEGMENTO <> "-"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   P_IN_REQUISICAO.COD_SEGMENTO5 ||
                                                   ' AND T.TIPO_SEGMENTO=5 AND T.COD_SEGMENTO <> "-"');
          insert into historico_perfil_campos
        ...
        IF P_IN_REQUISICAO.COD_SEGMENTO6 != V_COD_SEGMENTO6 THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   V_COD_SEGMENTO6 ||
                                                   ' AND T.TIPO_SEGMENTO=6 AND T.COD_SEGMENTO <> "-"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   P_IN_REQUISICAO.COD_SEGMENTO6 ||
                                                   ' AND T.TIPO_SEGMENTO=6 AND T.COD_SEGMENTO <> "-"');
          insert into historico_perfil_campos
        ...
        IF P_IN_REQUISICAO.COD_SEGMENTO7 != V_COD_SEGMENTO7 THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   V_COD_SEGMENTO7 ||
                                                   ' AND T.TIPO_SEGMENTO=7 AND T.COD_SEGMENTO <> "-"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT T.COD_SEGMENTO || " - " || T.DESCRICAO FROM reqpes.CODE_DESCRICOES_RH T WHERE T.COD_SEGMENTO=' ||
                                                   P_IN_REQUISICAO.COD_SEGMENTO7 ||
                                                   ' AND T.TIPO_SEGMENTO=7 AND T.COD_SEGMENTO <> "-"');
          insert into historico_perfil_campos
        ...
        IF P_IN_REQUISICAO.FONE_UNIDADE != V_FONE_UNIDADE THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Telefone',
             DECODE(V_FONE_UNIDADE, NULL, 'Nenhum', V_FONE_UNIDADE),
             P_IN_REQUISICAO.FONE_UNIDADE);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.JORNADA_TRABALHO != V_JORNADA_TRABALHO THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             DECODE(V_JORNADA_TRABALHO, NULL, 'Nenhum', V_JORNADA_TRABALHO),
             P_IN_REQUISICAO.JORNADA_TRABALHO);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.SUPERVISAO != V_SUPERVISAO THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             DECODE(V_SUPERVISAO, 'S', 'Sim', 'Não'),
             DECODE(P_IN_REQUISICAO.SUPERVISAO, 'S', 'Sim', 'Não'));
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.NR_FUNCIONARIO != V_NR_FUNCIONARIO THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Nº de funcionários',
             DECODE(V_NR_FUNCIONARIO, NULL, 'Nenhum', V_NR_FUNCIONARIO),
             P_IN_REQUISICAO.NR_FUNCIONARIO);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.DS_TAREFA != V_DS_TAREFA THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Descrição da tarefa',
             DECODE(V_DS_TAREFA, NULL, 'Nenhum', V_DS_TAREFA),
             P_IN_REQUISICAO.DS_TAREFA);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.NM_INDICADO != V_NM_INDICADO THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Nome indicado',
             DECODE(V_NM_INDICADO, NULL, 'Nenhum', V_NM_INDICADO),
             P_IN_REQUISICAO.NM_INDICADO);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.TP_CONTRATACAO != V_TP_CONTRATACAO THEN
          select tp.descricao
            into v_depois
            from reqpes.tipo_contratacao tp
           where tp.cod_tipo_contratacao = p_in_requisicao.tp_contratacao;
          select tp.descricao
            into v_antes
            from reqpes.tipo_contratacao tp
           where tp.cod_tipo_contratacao = v_tp_contratacao;
        ...
        IF (P_IN_REQUISICAO.INICIO_CONTRATACAO !=
           NVL(V_INICIO_CONTRATACAO, to_date('01/01/1900', 'dd/mm/yyyy')) OR
           P_IN_REQUISICAO.FIM_CONTRATACAO !=
           NVL(V_FIM_CONTRATACAO, to_date('01/01/1900', 'dd/mm/yyyy'))) THEN

          IF P_IN_REQUISICAO.TP_CONTRATACAO = 2 OR
             P_IN_REQUISICAO.TP_CONTRATACAO = 3 THEN
            insert into historico_perfil_campos
              (requisicao_sq,
               usuario_sq,
               dt_envio,
            ...
            values
              (V_REQUISICAO_SQ,
               ...
               P_DATA_HORA,
               'Fim da contratação',
               DECODE(V_FIM_CONTRATACAO, NULL, 'Nenhum', V_FIM_CONTRATACAO),
               P_IN_REQUISICAO.FIM_CONTRATACAO);
          ELSE
            IF P_IN_REQUISICAO.INICIO_CONTRATACAO !=
               NVL(V_INICIO_CONTRATACAO,
              ...
              values
                (V_REQUISICAO_SQ,
                 ...
                 DECODE(V_INICIO_CONTRATACAO,
                        ...
                        V_INICIO_CONTRATACAO),
                 P_IN_REQUISICAO.INICIO_CONTRATACAO);
            ELSIF P_IN_REQUISICAO.FIM_CONTRATACAO !=
                  NVL(V_FIM_CONTRATACAO,
                      to_date('01/01/1900', 'dd/mm/yyyy')) THEN
              insert into historico_perfil_campos
                (requisicao_sq,
                 usuario_sq,
        ...
        /*IF P_IN_REQUISICAO.FIM_CONTRATACAO != NVL(V_FIM_CONTRATACAO,to_date('01/01/1900','dd/mm/yyyy')) THEN
           ...
           IF P_IN_REQUISICAO.TP_CONTRATACAO = 2 OR P_IN_REQUISICAO.TP_CONTRATACAO = 3 THEN
             insert into historico_perfil_campos (requisicao_sq, usuario_sq, dt_envio, campo, conteudo_anterior, conteudo_novo) values
               (V_REQUISICAO_SQ, V_SQ_USUARIO, P_DATA_HORA, 'Início da contratação', DECODE(V_INICIO_CONTRATACAO,NULL,'Nenhum',V_INICIO_CONTRATACAO), P_IN_REQUISICAO.INICIO_CONTRATACAO);
           END IF;
        ...
        IF P_IN_REQUISICAO.RAZAO_SUBSTITUICAO !=
           NVL(V_RAZAO_SUBSTITUICAO, 0) THEN
          V_ANTES  := SP_DML_REQUISICAO_TRATAMENTO('SELECT DESCRICAO FROM VW_RHEV_TRANSFERENCIA_MOTIVO WHERE TRANSFERENCIA_MOTIVO_ID=' ||
                                                   NVL(V_RAZAO_SUBSTITUICAO,
                                                       0) ||
                                                   ' AND IND_MOTIVO = "T"');
          V_DEPOIS := SP_DML_REQUISICAO_TRATAMENTO('SELECT DESCRICAO FROM VW_RHEV_TRANSFERENCIA_MOTIVO WHERE TRANSFERENCIA_MOTIVO_ID=' ||
                                                   P_IN_REQUISICAO.RAZAO_SUBSTITUICAO ||
                                                   '  AND IND_MOTIVO = "T"');
          insert into historico_perfil_campos
            (requisicao_sq,
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             DECODE(V_ANTES, 'Vazio', 'Nenhum', V_ANTES),
             V_DEPOIS);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.TIPO_INDICACAO != V_TIPO_INDICACAO THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Tipo Indicação',
             DECODE(V_TIPO_INDICACAO, NULL, 'Nenhum', V_TIPO_INDICACAO),
             P_IN_REQUISICAO.TIPO_INDICACAO);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.NOME_INDICADO != V_NOME_INDICADO THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Nome Indicado',
             DECODE(V_NOME_INDICADO, NULL, 'Nenhum', V_NOME_INDICADO),
             P_IN_REQUISICAO.NOME_INDICADO);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.DS_MOTIVO_SOLICITACAO != V_DS_MOTIVO_SOLICITACAO THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Justificativa',
             DECODE(V_DS_MOTIVO_SOLICITACAO,
                    NULL,
                    'Nenhum',
                    V_DS_MOTIVO_SOLICITACAO),
             P_IN_REQUISICAO.DS_MOTIVO_SOLICITACAO);
        ...
        IF P_IN_REQUISICAO.ID_INDICADO != V_ID_INDICADO THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Indicado',
             DECODE(V_ID_INDICADO, NULL, 'Nenhum', V_DS_MOTIVO_SOLICITACAO),
             P_IN_REQUISICAO.ID_INDICADO);
          V_UPDATE := TRUE;
        END IF;

        IF P_IN_REQUISICAO.SUBSTITUIDO_ID_HIST !=
           NVL(V_SUBSTITUIDO_ID_HIST, 0) THEN

          IF NVL(V_SUBSTITUIDO_ID_HIST, 0) > 0 THEN
            SELECT F.NOME
              INTO V_ANTES
              FROM FUNCIONARIOS F
             WHERE F.ID = V_SUBSTITUIDO_ID_HIST;
          ELSE
            V_ANTES := 'Nenhum';
          END IF;
          ...
          SELECT F.NOME
            INTO V_DEPOIS
            FROM FUNCIONARIOS F
           WHERE F.ID = P_IN_REQUISICAO.SUBSTITUIDO_ID_HIST;
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Id Substituido',
             V_SUBSTITUIDO_ID_HIST || ' - ' || V_ANTES,
             P_IN_REQUISICAO.SUBSTITUIDO_ID_HIST || ' - ' || V_DEPOIS);
          V_UPDATE := TRUE;
        END IF;

        IF P_IN_REQUISICAO.TRANSFERENCIA_DATA !=
           NVL(V_TRANSFERENCIA_DATA, TO_DATE('01/01/1900', 'DD/MM/YYYY')) THEN
          insert into historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
             dt_envio,
        ...
        IF P_IN_REQUISICAO.IND_CARTA_CONVTE != NVL(V_IND_CARTA_CONVTE, 'X') THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Ind. Carta Convite',
             DECODE(V_IND_CARTA_CONVTE, NULL, 'Nenhum', V_IND_CARTA_CONVTE),
             P_IN_REQUISICAO.IND_CARTA_CONVTE);
          V_UPDATE := TRUE;
        END IF;

        IF P_IN_REQUISICAO.IND_EX_CARTA_CONVTE !=
           NVL(V_IND_EX_CARTA_CONVTE, 'X') THEN
          insert into historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
             dt_envio,
        ...
        IF P_IN_REQUISICAO.IND_EX_FUNCIONARIO !=
           NVL(V_IND_EX_FUNCIONARIO, 'X') THEN
          insert into historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
             dt_envio,
        ...
        IF P_IN_REQUISICAO.ID_CODE_COMBINATION !=
           NVL(V_ID_CODE_COMBINATION, 0) THEN
          insert into historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
             dt_envio,
        ...
        IF P_IN_REQUISICAO.IND_TIPO_REQUISICAO !=
           NVL(V_IND_TIPO_REQUISICAO, 'X') THEN
          insert into historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
             dt_envio,
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Tipo Requisição',
             decode(V_IND_TIPO_REQUISICAO, 'A', 'Admissão', 'Transferência'),
             decode(P_IN_REQUISICAO.IND_TIPO_REQUISICAO,
                    'A',
                    'Admissão',
                    'Transferência'));
          V_UPDATE := TRUE;
        ...
        --              insert into historico_perfil_campos (requisicao_sq, usuario_sq, dt_envio, campo, conteudo_anterior, conteudo_novo) values
        --              (V_REQUISICAO_SQ, V_SQ_USUARIO, P_DATA_HORA, 'Cód. Status', V_COD_STATUS,P_IN_REQUISICAO.COD_STATUS);
        --           END IF;

        IF P_IN_REQUISICAO.IND_CARATER_EXCECAO !=
           NVL(V_IND_CARATER_EXCECAO, 'X') THEN
          insert into historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
             dt_envio,
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             DECODE(V_IND_CARATER_EXCECAO,
                    'N',
                    'De acordo com a Instrução 10/2019',
                    'em caráter de exceção'),
             DECODE(P_IN_REQUISICAO.IND_CARATER_EXCECAO,
                    'N',
                    'De acordo com a Instrução 10/2019',
                    'em caráter de exceção'));
          V_UPDATE := TRUE;
        ...
        IF P_IN_REQUISICAO.VERSAO_SISTEMA != NVL(V_VERSAO_SISTEMA, 'X') THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Versão do Sistema',
             DECODE(V_VERSAO_SISTEMA, NULL, 'Nenhum', V_VERSAO_SISTEMA),
             P_IN_REQUISICAO.VERSAO_SISTEMA);
          V_UPDATE := TRUE;
        END IF;
        ...
        IF P_IN_REQUISICAO.ID_INDICADO != NVL(V_ID_INDICADO, 0) THEN
          ...
          values
            (V_REQUISICAO_SQ,
             ...
             P_DATA_HORA,
             'Id do indicado',
             DECODE(V_ID_INDICADO, NULL, 'Nenhum', V_ID_INDICADO),
             P_IN_REQUISICAO.ID_INDICADO);
          V_UPDATE := TRUE;
        END IF;

        IF (V_COD_UNIDADE != P_IN_REQUISICAO.COD_UNIDADE OR
           V_OBS != P_IN_REQUISICAO.OBS) THEN
          V_UPDATE := TRUE;
        END IF;
        ...
        IF (V_UPDATE) THEN
          ...
          UPDATE REQUISICAO
             SET IND_TIPO_REQUISICAO     = P_IN_REQUISICAO.IND_TIPO_REQUISICAO,
                 ...
                 NR_FUNCIONARIO          = NVL(P_IN_REQUISICAO.NR_FUNCIONARIO,
                                               0),
      ...
      ELSE
        ...
        INSERT INTO REQUISICAO_EXCLUIDA
          (REQUISICAO_SQ, FUNCIONARIO_ID, MOTIVO)
        VALUES
          (P_IN_REQUISICAO.REQUISICAO_SQ,
           P_IN_USUARIO,
           P_IN_REQUISICAO.DS_MOTIVO_SOLICITACAO);
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO || ' NA TABELA REQUISICAO' ||
                                SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
                                ' NA TABELA REQUISICAO' || SQLERRM);
    END;
  ...
  BEGIN
    BEGIN
      ...
      IF (P_IN_DML = 0) THEN
        ...
        SP_REQUISICAO_PERFIL_FUNCAO(P_IN_REQUISICAO_PERFIL.REQUISICAO_SQ,
                                    P_IN_LIST_FUNCAO);
      ...
      ELSIF (P_IN_DML > 0) THEN
        ...
        IF P_IN_GRAVA_HISTORICO_CHAPA > 0 THEN
          ...
          SELECT COD_UNIDADE,
                 ...
                 UNIDADE_ATUAL_USUARIO,
                 NIVEL
            INTO V_COD_UNIDADE_HIST,
                 V_DT_ENVIO_HIST,
                 V_DT_HOMOLOGACAO_HIST,
                 V_USUARIO_SQ_HIST,
                 V_STATUS_HIST,
     ...
     --     IF P_IN_SO_PERFIL = 1 THEN
      ...
      --    END IF;
          ...
          --  ROTINA QUE ATUALIZA O HISTORICO DO PERFIL
          --
          IF F_REMOVE_CARACTERES(TRIM(P_IN_REQUISICAO_PERFIL.DSC_ATIVIDADES_CARGO)) !=
             F_REMOVE_CARACTERES(TRIM(V_DSC_ATIVIDADES_CARGO)) THEN
            insert into historico_perfil_campos
              (requisicao_sq,
               usuario_sq,
               dt_envio,
          ...
          IF F_REMOVE_CARACTERES(TRIM(P_IN_REQUISICAO_PERFIL.DS_FORMACAO)) !=
             F_REMOVE_CARACTERES(TRIM(V_DS_FORMACAO)) THEN
            insert into historico_perfil_campos
              (requisicao_sq,
               usuario_sq,
               dt_envio,
          ...
          IF F_REMOVE_CARACTERES(TRIM(P_IN_REQUISICAO_PERFIL.DSC_EXPERIENCIA)) !=
             F_REMOVE_CARACTERES(TRIM(V_DSC_EXPERIENCIA)) THEN
            insert into historico_perfil_campos
              (requisicao_sq,
               usuario_sq,
               dt_envio,
          ...
          IF F_REMOVE_CARACTERES(TRIM(P_IN_REQUISICAO_PERFIL.DSC_CONHECIMENTOS)) !=
             F_REMOVE_CARACTERES(TRIM(V_DSC_CONHECIMENTOS)) THEN
            insert into historico_perfil_campos
              (requisicao_sq,
               usuario_sq,
               dt_envio,
          ...
          IF F_REMOVE_CARACTERES(TRIM(P_IN_REQUISICAO_PERFIL.OUTRAS_CARATERISTICA)) !=
             F_REMOVE_CARACTERES(TRIM(V_OUTRAS_CARATERISTICA)) THEN
            insert into historico_perfil_campos
              (requisicao_sq,
               usuario_sq,
               dt_envio,
          ...
          if F_REMOVE_CARACTERES(trim(p_in_requisicao_perfil.comentarios)) !=
             F_REMOVE_CARACTERES(TRIM(v_comentarios)) then
            insert into historico_perfil_campos
              (requisicao_sq,
               usuario_sq,
               dt_envio,
          ...
          if p_in_requisicao_perfil.cod_nivel_hierarquia !=
             v_cod_nivel_hierarquia then
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA REQUISICAO_PERFIL' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
  ...
  BEGIN
    BEGIN
      ...
      ELSIF (P_IN_DML > 0) THEN
        ...
        IF NVL(V_ID_CALENDARIO, -1) !=
           P_IN_REQUISICAO_JORNADA.ID_CALENDARIO THEN
          insert into historico_perfil_campos
            (requisicao_sq,
             usuario_sq,
             dt_envio,
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA REQUISICAO_JORNADA' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA USUARIO_AVISO' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
  ...
  BEGIN
    BEGIN
      ...
      IF (P_IN_DML = 0) THEN
        ...
        ------------------------------------------------------
        INSERT INTO HISTORICO_REQUISICAO
          (REQUISICAO_SQ, COD_UNIDADE, DT_ENVIO, USUARIO_SQ, STATUS)
        VALUES
          (P_IN_REQUISICAO_BAIXA.REQUISICAO_SQ,
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA REQUISICAO_BAIXA' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
  ...
  BEGIN
          ...
          BEGIN
            SELECT H.REQUISICAO_SQ,
              ...
              INTO P_IN_REQUISICAO_ESTORNO.REQUISICAO_SQ,
                   ...
                   V_COD_STATUS
              FROM HISTORICO_REQUISICAO H, REQUISICAO_STATUS RS
               ...
               WHERE H.REQUISICAO_SQ =
                 ...
                 AND H.DT_ENVIO =
                     (SELECT MAX(H1.DT_ENVIO) ATUAL
                       ...
                       WHERE H1.REQUISICAO_SQ = H.REQUISICAO_SQ
                         AND H1.NIVEL = 3
                         AND H1.STATUS NOT IN
                             ('estornou', 'estorno revisão')) -- WORKFLOW NÍVEL 2: APROVAÇÃO DO GERENTE => HOMOLOGADOR GEP - AP&B
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO || 'OPÇÃO: ' ||
                                P_IN_IND_TIPO_ESTORNO ||
                                ' NA TABELA REQUISICAO' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
    ...
    BEGIN
      ...
      IF (P_IN_DML = 0) THEN
        ...
        INSERT INTO REQUISICAO_REVISAO
          (REQUISICAO_SQ, NRO_REVISAO, STATUS, MOTIVO)
        VALUES
      ...
      ELSIF (P_IN_DML > 0) THEN
        ...
        -----------------------------------------------------
        SELECT R.COD_STATUS, R.COD_UNIDADE
          INTO V_STATUS_RP, V_UO_RP
          FROM REQUISICAO R
         WHERE R.REQUISICAO_SQ = P_IN_REQUISICAO_REVISAO.REQUISICAO_SQ;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA REQUISICAO_REVISAO' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
  ...
  PROCEDURE SP_DML_REQUISICAO_HOMOLOGACAO(P_IN_TIPO       IN VARCHAR2,
                                          P_IN_REQUISICAO IN HISTORICO_REQUISICAO%ROWTYPE,
                                          P_IN_USUARIO    IN VARCHAR2,
                                          P_IN_DSC_MOTIVO IN VARCHAR2) IS
    TIPO_TRANSACAO VARCHAR2(50);
    ...
    BEGIN
      ...
      ELSIF (P_IN_TIPO = 'R') THEN
        ...
        INSERT INTO REQUISICAO_REPROVADA
          (REQUISICAO_SQ, COD_UNIDADE, DT_REPROVADA, MOTIVO)
        VALUES
          (P_IN_REQUISICAO.REQUISICAO_SQ,
           P_IN_REQUISICAO.COD_UNIDADE,
           SYSDATE,
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NO PROCESSO DE HOMOLOGAÇÃO' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
  ...
  PROCEDURE SP_DML_SUBSTITUICAO_GERENTE(P_IN_DML          IN VARCHAR2,
    ...
    V_DAT_FIM_VIGEN          VARCHAR2(10) := TO_CHAR(P_IN_SUBSTITUICAO.REST_DAT_FIN_VIGEN,
                                                     'DD/MM/YYYY');
  BEGIN
    BEGIN
      -- ############# VERIFICANDO O TIPO DE TRANSAÇÃO  ################# --
      IF (P_IN_DML = 0) THEN
        ...
        SELECT FUNC_ID
         ...
         WHERE RE.TEOR_COD = P_IN_TEOR_COD
           ...
           AND TRUNC(SYSDATE) BETWEEN RE.REST_DAT_INI_VIGEN AND
               RE.REST_DAT_FIN_VIGEN;
        ----------------------------------------------------
      ...
      ELSIF (P_IN_DML = 1) THEN
        ...
        UPDATE RESPONSAVEL_ESTRUTURA RE
         ...
         WHERE RE.TEOR_COD = P_IN_TEOR_COD
           ...
           AND RE.UNOR_COD = P_IN_SUBSTITUICAO.UNOR_COD
           AND (TRUNC(SYSDATE) BETWEEN RE.REST_DAT_INI_VIGEN AND
               RE.REST_DAT_FIN_VIGEN OR
               TRUNC(SYSDATE) >
               (SELECT MAX(R1.REST_DAT_FIN_VIGEN)
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NO PROCESSO DE SUBSTITUICAO_GERENTE' ||
                                SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
  ...
  BEGIN
    BEGIN
      ...
      ELSE
        ...
        TIPO_TRANSACAO := 'DELETE';
        -----------------------------------------------------
        DELETE FROM TABELA_SALARIAL_ATRIBUICAO
         WHERE COD_TAB_SALARIAL = P_IN_TABELA_SALARIAL.COD_TAB_SALARIAL;
        DELETE FROM TABELA_SALARIAL
         WHERE COD_TAB_SALARIAL = P_IN_TABELA_SALARIAL.COD_TAB_SALARIAL;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA TABELA_SALARIAL' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
  ...
  PROCEDURE SP_DML_TAB_SALARIAL_ATRIBUICAO(P_IN_DML                     IN NUMBER,
                                           P_IN_TAB_SALARIAL_ATRIBUICAO IN OUT TABELA_SALARIAL_ATRIBUICAO%ROWTYPE) IS
    ...
    BEGIN
      ...
      IF (P_IN_DML = 0) THEN
        ...
        INSERT INTO TABELA_SALARIAL_ATRIBUICAO
          (COD_TAB_SALARIAL, COD_TAB_SALARIAL_RHEV)
        VALUES
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA TABELA_SALARIAL_ATRIBUICAO' ||
                                SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
  ...
  BEGIN
    BEGIN
      ...
      ELSE
        ...
        DELETE FROM INSTRUCAO_ATRIBUICAO
         WHERE COD_INSTRUCAO = P_IN_INSTRUCAO.COD_INSTRUCAO;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO || ' NA TABELA INSTRUCAO' ||
                                SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
                                ' NA TABELA INSTRUCAO' || SQLERRM);
    END;
  ...
  PROCEDURE SP_DML_INSTRUCAO_ATRIBUICAO(P_IN_DML                  IN NUMBER,
                                        P_IN_INSTRUCAO_ATRIBUICAO IN OUT INSTRUCAO_ATRIBUICAO%ROWTYPE) IS
    TIPO_TRANSACAO VARCHAR2(50) := 'DELETE / INSERT';
  BEGIN
    BEGIN
      ...
      ELSE
        ...
        -----------------------------------------------------
        DELETE FROM INSTRUCAO_ATRIBUICAO
         WHERE COD_INSTRUCAO = P_IN_INSTRUCAO_ATRIBUICAO.COD_INSTRUCAO;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA INSTRUCAO_ATRIBUICAO' ||
                                SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
  ...
  BEGIN
    BEGIN
      ...
      IF (P_IN_DML = 0) THEN
        ...
        INSERT INTO GRUPO_NEC
          (COD_GRUPO, DSC_GRUPO, USER_CADASTRO)
        VALUES
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO || ' NA TABELA GRUPO_NEC' ||
                                SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
                                ' NA TABELA GRUPO_NEC' || SQLERRM);
    END;
  ...
  PROCEDURE SP_DML_GRUPO_NEC_UNIDADES(P_IN_DML                IN NUMBER,
                                      P_IN_GRUPO_NEC_UNIDADES IN OUT GRUPO_NEC_UNIDADES%ROWTYPE) IS
    TIPO_TRANSACAO VARCHAR2(50) := 'DELETE / INSERT';
  BEGIN
    BEGIN
      ...
      ELSE
        ...
        DELETE FROM GRUPO_NEC_UNIDADES
         WHERE COD_GRUPO = P_IN_GRUPO_NEC_UNIDADES.COD_GRUPO;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA GRUPO_NEC_UNIDADES' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
  ...
  BEGIN
    BEGIN
      ...
      ELSE
        ...
        -- REMOVENDO O ACESSO
        -----------------------------------------------------
        DELETE FROM GRUPO_NEC_USUARIOS
         WHERE CHAPA = P_IN_GRUPO_NEC_USUARIOS.CHAPA;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA GRUPO_NEC_USUARIOS' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
    ...
    BEGIN
      ...
      IF (P_IN_DML = 0) THEN
        ...
        INSERT INTO UO_CARGO_ADM_COORD
          (COD_UNIDADE, USER_CADASTRO)
        VALUES
          (P_IN_UO_CARGO_ADM_COORD.COD_UNIDADE, P_IN_USUARIO);
      ...
      ELSE
        ...
        -----------------------------------------------------
        TIPO_TRANSACAO := 'DELETE';
        DELETE FROM UO_CARGO_ADM_COORD
         WHERE COD_UNIDADE = P_IN_UO_CARGO_ADM_COORD.COD_UNIDADE;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO ||
                                ' NA TABELA UO_CARGO_ADM_COORD' || SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
  ...
  BEGIN
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA: DADOS NÃO ENCONTRADOS AO FAZER ' ||
                                TIPO_TRANSACAO || ' NA TABELA TIPO_AVISO' ||
                                SQLERRM);
      WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,
                                'PROBLEMA AO FAZER ' || TIPO_TRANSACAO ||
                                ' NA TABELA TIPO_AVISO' || SQLERRM);
    END;
  ...
  BEGIN
    ...
    IF (P_LIST_FUNCAO IS NOT NULL) THEN
      INSERT INTO REQUISICAO_PERFIL_FUNCAO
        (REQUISICAO_SQ, COD_FUNCAO)
        SELECT P_REQUISICAO_SQ, T.ID_FUNCAO
          FROM RECRU_FUNCAO T
  ...
  EXCEPTION
    WHEN NO_DATA_FOUND THEN
      ROLLBACK;
      RAISE_APPLICATION_ERROR(-20024,
                              'PROBLEMA: DADOS NÃO ENCONTRADOS NA INCLUSÃO DA TABELA REQUISICAO_PERFIL_FUNCAO' ||
                              SQLERRM);
    WHEN OTHERS THEN
      ROLLBACK;
      RAISE_APPLICATION_ERROR(-20024,
                              'PROBLEMA AO FAZER DML NA TABELA REQUISICAO_PERFIL_FUNCAO' ||
                              SQLERRM);
